...
****************************************************************************/
/****************************************************************************
SECTION: SIDEBAR AUTO-OCULTABLE + FX-AUTOCONFIG                           *
****************************************************************************/

// Necesario para userChrome.css / userContent.css
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);

// Autoconfig / userChrome JS
user_pref("general.config.filename", "config.js");
user_pref("general.config.obscure_value", 0);

// Si el script JS no carga, prueba con esto:
user_pref("general.config.sandbox_enabled", false);
// Desactivar el "sidebar revamp" de Firefox; usamos nuestra sidebar clásica
user_pref("browser.sidebar.revamp", false);
